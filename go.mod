...
require (
	...
	kmodules.xyz/resource-metadata v0.25.2-0.20250218213156-6bd1d9d0bcd6
	...
	kubepack.dev/lib-helm v0.29.14-0.20250218220146-ed15c0e39bc3
	open-cluster-management.io/api v0.15.0
	sigs.k8s.io/cli-utils v0.37.2
	sigs.k8s.io/controller-runtime v0.18.4
	sigs.k8s.io/gateway-api v1.1.0
	sigs.k8s.io/yaml v1.4.0
	x-helm.dev/apimachinery v0.0.17-0.20250218214431-d125b4e91d1f
)
